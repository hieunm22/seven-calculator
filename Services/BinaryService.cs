...
namespace Calculator
{
    ...
    public static class BinaryService
    {
        ...
        /// </summary>
        public static string DecimalToOthers(string decimalNumber, /*int from, */int dest, int size, bool isSign)
        {
        ...
        /// </summary>
        public static string OthersToDecimal(string decimalNumber, int dest, int size, bool isSign)
        {
