...
namespace Calculator
{
    public partial class BigNumber
    {
        ...
        {
            Copy(s, d);
            if (d.SignNum < 0) d.SignNum = 1;
        }

        static void Neg(BigNumber s, BigNumber d)
        {
            Copy(s, d);
            if (d.SignNum != 0) d.SignNum = (sbyte)(-d.SignNum);
        }
        ...
        static private void M_raw_exp(BigNumber xx, BigNumber rr, int places)
        {
            ...
            while (true)
            {
                ...
                if ((term.Exponent < tolerance) || (term.SignNum == 0))
                    break;
        ...
        static void SQrtGuess(BigNumber a, BigNumber r)
        {
            ...
            scci.NumberFormat.NumberDecimalSeparator = MathService.DecimalSeparator;
        ...
        static void Sqrt(BigNumber src, BigNumber dst, int places)
        {
            ...
            if (src.SignNum <= 0 && src.SignNum == -1)
            {
        ...
        static void M_log_solve_cubic(BigNumber nn, BigNumber rr, int places)
        {
            ...
            while (true)
            {
                ...
                if (ii != 0)
                {
                    if (((3 * tmp0.Exponent) < tolerance) || (tmp0.SignNum == 0)) break;
                }
        ...
        static void LogAGMRFunc(BigNumber aa, BigNumber bb, BigNumber rr, int places)
        {
            ...
            while (true)
            {
                ...
                if ((tmp1.SignNum == 0) || ((-2 * tmp1.Exponent) > tolerance)) break;
        ...
        static void M_log_near_1(BigNumber xx, BigNumber rr, int places)
        {
            ...
            Mul(term, tmp2, tmp0);
            while (tmp0.Exponent >= tolerance && tmp0.SignNum != 0)
            {
        ...
        static void LogE(BigNumber src, BigNumber dst, int places)
        {
            ...
            if (mexp == 0 || mexp == 1)
            {
                ...
                if (tmp0.SignNum == 0)    /* is input exactly 1 ?? */
                {                           /* if so, result is 0    */
                    SetZero(dst);
                    return;
                }
        ...
        static private string ToFullString(BigNumber atm)
        {
            ...
            if (exp > 0)
            {
                ...
                if (exp < res.Length)
                {
                    res = res.Insert((int)exp, MathService.DecimalSeparator);
                }
            }
            else
            {
                ...
                if (res.Length >= 2)
                {
                    res = res.Insert(1, MathService.DecimalSeparator);
                }
            }
            if (atm.SignNum < 0) res = "-" + res;
            return res;
        }
        ...
        static private string ToExpString(BigNumber atm, int digits)
        {
            ...
            if (ctmp.SignNum == 0)
            {
                ...
                else
                {
                    ...
                    if (dec_places > 0)
                    {
                        res += MathService.DecimalSeparator;
                    }
