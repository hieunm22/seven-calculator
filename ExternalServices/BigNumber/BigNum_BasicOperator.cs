...
namespace Calculator
{
    public partial class BigNumber
    {
        ...
        static private void FastMul(BigNumber aa, BigNumber bb, BigNumber rr)
        {
            ...
            sign = M_ain.SignNum * M_bin.SignNum;
        ...
        static private void Mul(BigNumber aa, BigNumber bb, BigNumber rr)
        {
            ...
            sign = (sbyte)(aa.SignNum * bb.SignNum);
            ...
            rr.SignNum = sign;
            rr.Exponent = nexp;
            rr.dataLength = numdigits > NUM_DEFAULT_PLACES ? NUM_DEFAULT_PLACES + 1 : numdigits;
        ...
        static private void Div(BigNumber aa, BigNumber bb, BigNumber rr, long places)
        {
            ...
            if (aa.Exponent > NUM_DEFAULT_PLACES || bb.Exponent > NUM_DEFAULT_PLACES)
            {
            ...
            else       /* 'normal' step D1 */
            {
                ...
                M_div_worka.SignNum = 1;
                M_div_workb.SignNum = 1;
            }
        ...
        static void DivGetRemainder(BigNumber c1, BigNumber c2, BigNumber res)
        {
            ...
            if (c1.Exponent - c2.Exponent > NUM_DEFAULT_PLACES
                || c1.Exponent > NUM_DEFAULT_PLACES || c2.Exponent > NUM_DEFAULT_PLACES)
            {
                // tạm thời thế
            ...
            sign.SignNum = c1.SignNum;    // c1, NOT c2
        ...
        static void Add(BigNumber src, BigNumber dst, BigNumber result)
        {
            ...
            if (src.SignNum == 1 && dst.SignNum == -1)
            {
                dst.SignNum = 1;
                Sub(src, dst, result);
                dst.SignNum = -1;
        ...
        static private void SetFromString(BigNumber atm, string value)
        {
            ...
            value = value.Replace(MathService.GroupSeparator, MathService.DecimalSeparator);

            int j = value.IndexOf(MathService.DecimalSeparator);
            if (j == -1)
            {
                value = value + MathService.DecimalSeparator;
                j = value.Length - 1;   //j = value.IndexOf(Common.DecimalSeparator);
            }

            exponent += j;              // atm.stringvalue.length
            value = value.Remove(value.IndexOf(MathService.DecimalSeparator), 1);
